...
<body>
<h1>iroh-ffi</h1>
<p class="ver">iroh {html.escape(version)} &middot; bindings for Swift, Kotlin, Python, JavaScript &amp; Zig</p>
<p>A minimal FFI mirroring the iroh 1.0 API. Pick a language for its API guide or reference:</p>
