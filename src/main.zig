    ...
    while (!ui.shouldClose()) {
        ...
        if (ui_state.emulation_running) {
            ...
            if (main_window_active) {
                ...
                if (ui.isKeyPressed(ui_state.generalBinding(.restart))) ui_state.resetSystem();
                ...
                if (ui_state.step_mode and ui.isKeyPressed(ui_state.generalBinding(.run_tick))) ui_state.runSystemTick();
                if (ui_state.step_mode and ui.isKeyPressed(ui_state.generalBinding(.run_frame))) {
