...
pub const TextRenderer = struct {
    ...
    pub fn init(renderer: ?*c.SDL_Renderer) Self {
        ...
        sdlError(c.SDL_SetTextureScaleMode(font_texture, c.SDL_SCALEMODE_NEAREST));
    ...
    pub fn render_with_color(self: *Self, x: f32, y: f32, text: []const u8, color: Color) void {
        ...
        sdlError(c.SDL_GetTextureColorMod(self.font_texture, &old_r, &old_g, &old_b));
        sdlError(c.SDL_SetTextureColorMod(self.font_texture, color.r, color.g, color.b));
        ...
        sdlError(c.SDL_SetTextureColorMod(self.font_texture, old_r, old_g, old_b));
    }
