...
fn audio_stream_callback(userdata: ?*anyopaque, stream_arg: ?*c.SDL_AudioStream, additional_amount: c_int, total_amount: c_int) void {
    _ = additional_amount;
    ...
    const transferred_bytes_usize: usize = @min(max_bytes, total_bytes);
