...
// pub const SYSTEM_PALLETE: [64]Color = [_]Color{
//    Color.RGB(0x54, 0x54, 0x54), Color.RGB(0x00, 0x1E, 0x74), Color.RGB(0x08, 0x10, 0x90), Color.RGB(0x30, 0x00, 0x88), Color.RGB(0x44, 0x00, 0x64),
//    Color.RGB(0x5C, 0x00, 0x30), Color.RGB(0x54, 0x04, 0x00), Color.RGB(0x3C, 0x18, 0x00), Color.RGB(0x20, 0x2A, 0x00), Color.RGB(0x08, 0x3A, 0x00),
//    Color.RGB(0x00, 0x40, 0x00), Color.RGB(0x00, 0x3C, 0x00), Color.RGB(0x00, 0x32, 0x3C), Color.RGB(0x00, 0x00, 0x00), Color.RGB(0x00, 0x00, 0x00),
//    Color.RGB(0x00, 0x00, 0x00), Color.RGB(0x98, 0x96, 0x98), Color.RGB(0x08, 0x4C, 0xC4), Color.RGB(0x30, 0x32, 0xEC), Color.RGB(0x5C, 0x1E, 0xE4),
//    Color.RGB(0x88, 0x14, 0xB0), Color.RGB(0xA0, 0x14, 0x64), Color.RGB(0x98, 0x22, 0x20), Color.RGB(0x78, 0x3C, 0x00), Color.RGB(0x54, 0x5A, 0x00),
//    Color.RGB(0x28, 0x72, 0x00), Color.RGB(0x08, 0x7C, 0x00), Color.RGB(0x00, 0x76, 0x28), Color.RGB(0x00, 0x66, 0x78), Color.RGB(0x00, 0x00, 0x00),
//    Color.RGB(0x00, 0x00, 0x00), Color.RGB(0x00, 0x00, 0x00), Color.RGB(0xEC, 0xEE, 0xEC), Color.RGB(0x4C, 0x9A, 0xEC), Color.RGB(0x78, 0x7C, 0xEC),
//    Color.RGB(0xB0, 0x62, 0xEC), Color.RGB(0xE4, 0x54, 0xEC), Color.RGB(0xEC, 0x58, 0xB4), Color.RGB(0xEC, 0x6A, 0x64), Color.RGB(0xD4, 0x88, 0x20),
//    Color.RGB(0xA0, 0xAA, 0x00), Color.RGB(0x74, 0xC4, 0x00), Color.RGB(0x4C, 0xD0, 0x20), Color.RGB(0x38, 0xCC, 0x6C), Color.RGB(0x38, 0xB4, 0xCC),
//    Color.RGB(0x3C, 0x3C, 0x3C), Color.RGB(0x00, 0x00, 0x00), Color.RGB(0x00, 0x00, 0x00), Color.RGB(0xEC, 0xEE, 0xEC), Color.RGB(0xA8, 0xCC, 0xEC),
//    Color.RGB(0xBC, 0xBC, 0xEC), Color.RGB(0xD4, 0xB2, 0xEC), Color.RGB(0xEC, 0xAE, 0xEC), Color.RGB(0xEC, 0xAE, 0xD4), Color.RGB(0xEC, 0xB4, 0xB0),
//    Color.RGB(0xE4, 0xC4, 0x90), Color.RGB(0xCC, 0xD2, 0x78), Color.RGB(0xB4, 0xDE, 0x78), Color.RGB(0xA8, 0xE2, 0x90), Color.RGB(0x98, 0xE2, 0xB4),
//    Color.RGB(0xA0, 0xD6, 0xE4), Color.RGB(0xA0, 0xA2, 0xA0), Color.RGB(0x00, 0x00, 0x00), Color.RGB(0x00, 0x00, 0x00)
// };
// zig fmt: on
